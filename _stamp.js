...
function jsx(element, attributes, ...children) {
  ...
  if (typeof element === "string") {
    const { bind, immediateBind, childrenBind, childrenBindMode, events, styleBind, immediateStyleBind, classBind, immediateClassBind, ...otherAttributes } = attributes ?? {};
    return {
      type: "element",
      element,
      attributes: otherAttributes,
...
function buildElement(description, context, document2 = globalThis.document) {
  ...
  if (description.element.includes(":")) {
    ...
    element = document2.createElementNS(context.defaultNamespace, description.element);
  } else {
...
function buildNode(description, container2, elementBinds, nodeBinds, context, document2 = globalThis.document) {
  switch (description.type) {
    case "element": {
      const { element, context: newContext } = buildElement(description, context, document2);
    ...
    case "fragment":
      ...
      for (const child of description.children) {
        ...
        buildTree(child, container2, elementBinds, nodeBinds, context, document2);
      }
      if (description.childrenBind && description.childrenBindMode !== "prepend") {
        const fragmentComment = document2.createComment("fragment children binding");
        container2.appendChild(fragmentComment);
      ...
      return { container: container2, context };
    case "static":
...
function buildTree(description, container2 = null, elementBinds = [], nodeBinds = [], context, document2 = globalThis.document) {
  if (!container2 && description.type === "element") {
  ...
  } else if (!container2 && description.type === "empty" && !context?.skipEmpty) {
    const emptyComment = document2.createComment("empty");
    return {
      elementBinds,
      nodeBinds,
    ...
    buildNode(description, container2, elementBinds, nodeBinds, context, document2);
  } else {
    const nextNode = buildNode(description, container2, elementBinds, nodeBinds, context, document2);
    if (nextNode !== null) {
...
function buildStamp(description, document2 = globalThis.document) {
  ...
  const { elementBinds, nodeBinds } = buildTree(description, template.content, void 0, void 0, { skipEmpty: true, defaultNamespace: null, namespaceMap: {} }, document2);
  let i = 0;
...
function PronounNode({ game: game2 }) {
  const pronounChoice = game2.pronoun.pipe(
    (0, import_rxjs3.map)(
      (pronoun) => !pronoun || pronoun === "" ? () => /* @__PURE__ */ jsx(PronounChoice, { pronounVm: game2.pronounVm }) : () => /* @__PURE__ */ jsx(AfterPronoun, { pronounVm: game2.pronounVm })
    )
  );
...
function WeaponNode({ game: game2 }, { bindEffect, events }) {
  ...
  return /* @__PURE__ */ jsx(Fragment, null, /* @__PURE__ */ jsx("h1", null, "Mr. Gravel's Office"), /* @__PURE__ */ jsx("p", null, '"Ah, ', /* @__PURE__ */ jsx("span", { bind: { innerText: game2.honorific } }), " ", /* @__PURE__ */ jsx(
    "input",
    {
      title: "Player Name",
      type: "text",
...
function AfterTea({ game: game2 }) {
  const chefTea = game2.className.pipe(
    (0, import_rxjs5.map)((className) => className === "Chef" ? ChefTea : Empty)
  );
...
function CharacterType({ game: game2 }) {
  return /* @__PURE__ */ jsx("p", null, "You are ", /* @__PURE__ */ jsx("span", { bind: { innerText: game2.a } }), " ", /* @__PURE__ */ jsx("span", { bind: { innerText: game2.gender } }), " ", /* @__PURE__ */ jsx("span", { bind: { innerText: game2.race } }), " ", /* @__PURE__ */ jsx("span", { bind: { innerText: game2.className } }), ".");
}
function Weapon({ game: game2 }) {
  return /* @__PURE__ */ jsx("p", null, "You are wielding your ", /* @__PURE__ */ jsx("span", { bind: { innerText: game2.weapon } }), ".");
}
function GamePage(_props, { bindEffect, events }) {
  ...
  const characterType = game2.race.pipe(
    (0, import_rxjs7.map)(
      (race2) => !race2 || race2 === "" ? GetStarted : () => /* @__PURE__ */ jsx(CharacterType, { game: game2 })
    )
  );
  const ap = game2.ap.pipe((0, import_rxjs7.map)((ap2) => ap2.toLocaleString()));
  const weapon = game2.weapon.pipe(
    (0, import_rxjs7.map)(
      (weapon2) => !weapon2 || weapon2 === "" ? Empty : () => /* @__PURE__ */ jsx(Weapon, { game: game2 })
    )
  );
...
function Main() {
  ...
  return /* @__PURE__ */ jsx(Fragment, null, /* @__PURE__ */ jsx(NavBar, { router: router2 }), /* @__PURE__ */ jsx(
    "div",
    {
      id: "page",
      className: "container",
