...
var require_Observable = __commonJS({
  'node_modules/rxjs/dist/cjs/internal/Observable.js'(exports) {
    ...
    var Observable3 = (function () {
      ...
      Observable4.prototype.subscribe = function (
        observerOrNext,
        error,
        complete,
      ) {
...
var require_NotFoundError = __commonJS({
  'node_modules/rxjs/dist/cjs/internal/util/NotFoundError.js'(exports) {
    ...
    var createErrorClass_1 = require_createErrorClass()
    exports.NotFoundError = createErrorClass_1.createErrorClass(
      function (_super) {
...
var require_SequenceError = __commonJS({
  'node_modules/rxjs/dist/cjs/internal/util/SequenceError.js'(exports) {
    ...
    var createErrorClass_1 = require_createErrorClass()
    exports.SequenceError = createErrorClass_1.createErrorClass(
      function (_super) {
...
var require_timeout = __commonJS({
  'node_modules/rxjs/dist/cjs/internal/operators/timeout.js'(exports) {
    ...
    var OperatorSubscriber_1 = require_OperatorSubscriber()
    var executeSchedule_1 = require_executeSchedule()
    exports.TimeoutError = createErrorClass_1.createErrorClass(
      function (_super) {
...
var require_fromEvent = __commonJS({
  'node_modules/rxjs/dist/cjs/internal/observable/fromEvent.js'(exports) {
    ...
    function fromEvent2(target, eventName, options, resultSelector) {
      ...
      if (resultSelector) {
        return fromEvent2(target, eventName, options).pipe(
...
var require_shareReplay = __commonJS({
  'node_modules/rxjs/dist/cjs/internal/operators/shareReplay.js'(exports) {
    ...
    function shareReplay3(configOrBufferSize, windowTime, scheduler) {
      var _a, _b, _c
      var bufferSize
      var refCount = false
    ...
    exports.shareReplay = shareReplay3
  },
})
  ...
  'node_modules/rxjs-spy/cjs/operators/tag.js'(exports) {
    ...
    function tag2(tag3) {
      return function tagOperation(source) {
        return source.lift(new TagOperator(tag3))
      }
    }
    exports.tag = tag2
    var TagOperator = (function () {
      function TagOperator2(tag3) {
        this.tag = tag3
      }
...
function makeTestEvent(observable) {
...
function makeTestComponentContext(events) {
  const effects = []
...
function butterfly(startingValue) {
  const subject = new import_rxjs.BehaviorSubject(startingValue)
...
/* @__PURE__ */ ;(function (jsx2) {})(jsx || (jsx = {}))
...
// node_modules/butterfloat/stamp-builder.js
function buildStamp(description, document2 = globalThis.document) {
  ...
  for (const [element, desc] of nodeBinds) {
    const slot = document2.createElement('slot')
...
function NavBar({ router: router2 }) {
  const homeActive = router2.page.pipe(
    (0, import_rxjs2.map)((page) => (page === 'home' ? true : false)),
  )
  const aboutActive = router2.page.pipe(
    (0, import_rxjs2.map)((page) => (page === 'about' ? true : false)),
  )
  return /* @__PURE__ */ jsx(
    'div',
    ...
    /* @__PURE__ */ jsx(
      ...
      /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsx(
          ...
          /* @__PURE__ */ jsx(
            'li',
            { classBind: { active: homeActive } },
            /* @__PURE__ */ jsx('a', { href: '#' }, 'Home'),
          ),
          /* @__PURE__ */ jsx(
            'li',
            { classBind: { active: aboutActive } },
            /* @__PURE__ */ jsx('a', { href: '#about' }, 'About'),
          ),
        ),
      ),
    ),
...
function HomePage() {
  return /* @__PURE__ */ jsx(
    'div',
    { className: 'jumbotron' },
    /* @__PURE__ */ jsx('h1', null, 'Macro Transaction Force Go!'),
    /* @__PURE__ */ jsx(
      'p',
      null,
      "For as long as you can remember you've wanted to be a member of the universe-renowned Macro Transaction Force, one of the most elite forces in the galaxy. Their barrier to entry is rather high, but everyone knows it must be worth it.",
    ),
    /* @__PURE__ */ jsx(
      'p',
      null,
      /* @__PURE__ */ jsx(
        'em',
        null,
        /* @__PURE__ */ jsx('strong', null, 'NOTE:'),
        ' This is a work of satire from 2014. Some of the jokes may not have aged well, as satire is hard on the modern internet. Unfortunately, some of the jokes seem to be timeless.',
      ),
    ),
    /* @__PURE__ */ jsx(
      'a',
      { className: 'btn btn-primary', href: '#play' },
      'Play the Game',
    ),
  )
}
...
function AboutPage() {
  return /* @__PURE__ */ jsx(
    Fragment,
    null,
    /* @__PURE__ */ jsx('h1', null, 'About'),
    /* @__PURE__ */ jsx(
      'p',
      null,
      /* @__PURE__ */ jsx('em', null, 'Macro Transaction Force Go!'),
      ' is a serious study in',
      ' ',
      /* @__PURE__ */ jsx(
        'a',
        { href: 'http://itch.io/jam/ruinjam2014' },
        'the ruination of videogames',
      ),
      ' ',
      'by ',
      /* @__PURE__ */ jsx(
        'a',
        { href: 'http://worldmaker.net' },
        'Max Battcher',
      ),
      '.',
    ),
    /* @__PURE__ */ jsx(
      ...
      null,
      'Nothing quite says ',
      /* @__PURE__ */ jsx('strong', null, 'videogames'),
      ' like a custom engine, because why should we share our nice toys? This unnamed semi-proprietary TypeScript game engine is cobbled together (in 2023) with',
      ' ',
      /* @__PURE__ */ jsx(
        'a',
        { href: 'https://github.com/WorldMaker/butterfloat' },
        'Butterfloat',
      ),
      ' ',
      'components.',
...
// src/nodes/race.tsx
function RaceNode({ game: game2 }, { bindImmediateEffect, events }) {
  ...
  return /* @__PURE__ */ jsx(
    Fragment,
    null,
    /* @__PURE__ */ jsx('h1', null, 'Choose Your Race'),
    /* @__PURE__ */ jsx(
      'div',
      ...
      /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsx(
          ...
          'Outwardly terrifying, the Darkstar Orcs were once the unpaid labor force of the Galaxy due to their good work ethic, even if few people will pay them that compliment.',
        ),
      ),
      /* @__PURE__ */ jsx(
        'a',
        { className: 'list-group-item', href: '#', events: { click: rabbit } },
        /* @__PURE__ */ jsx(
          'h4',
          { className: 'list-group-item-heading' },
          'Gamma Rabbit',
      ...
      /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsx(
          ...
          /* @__PURE__ */ jsx(
            ...
            '6000 ',
            /* @__PURE__ */ jsx('span', { className: 'fa fa-btc' }),
          ),
        ),
        /* @__PURE__ */ jsx(
          'p',
...
// src/nodes/class.tsx
function ClassNode({ game: game2 }, { bindImmediateEffect, events }) {
  ...
  return /* @__PURE__ */ jsx(
    Fragment,
    null,
    /* @__PURE__ */ jsx('h1', null, 'Choose Your Class'),
    /* @__PURE__ */ jsx(
      'div',
      { className: 'list-group' },
      /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsx(
          'p',
          { className: 'list-group-item-text' },
          'Once a specialized role of choice for dangerous people, there seems to be a new one every year.',
        ),
      ),
      /* @__PURE__ */ jsx(
        'a',
        { className: 'list-group-item', href: '#', events: { click: chef } },
        /* @__PURE__ */ jsx(
          'h4',
          { className: 'list-group-item-heading' },
          'Chef',
        ...
        /* @__PURE__ */ jsx(
          ...
          /* @__PURE__ */ jsx(
            ...
            /* @__PURE__ */ jsx(
              ...
              '6000 ',
              /* @__PURE__ */ jsx('span', { class: 'fa fa-btc' }),
            ),
          ),
          /* @__PURE__ */ jsx(
            'p',
            { className: 'list-group-item-text' },
            'Gamers can command the respect of the entire galaxy with their elite skills and monster hardcore abilities.',
          ),
        ),
        /* @__PURE__ */ jsx(
          'a',
          { className: 'list-group-item', href: '#', events: { click: sjw } },
          /* @__PURE__ */ jsx(
            'h4',
            { className: 'list-group-item-heading' },
          ...
          /* @__PURE__ */ jsx(
            'p',
            { className: 'list-group-item-text' },
            'The blind fury of Justice, these Warriors fight for a just society, or so they claim.',
          ),
        ),
      ),
    ),
...
function GenderNode({ game: game2 }, { bindImmediateEffect, events }) {
  const { agender, female, herm, transfemale, transmale } = events
  const { genderVm } = game2
  ...
  return /* @__PURE__ */ jsx(
    Fragment,
    null,
    /* @__PURE__ */ jsx('h1', null, 'Choose Your Gender'),
    /* @__PURE__ */ jsx(
      'div',
      { className: 'list-group' },
      /* @__PURE__ */ jsx(
        'a',
        { className: 'list-group-item', href: '#', events: { click: agender } },
        /* @__PURE__ */ jsx(
          'h4',
          { className: 'list-group-item-heading' },
          'Agender',
        ...
        /* @__PURE__ */ jsx(
          'p',
          { className: 'list-group-item-text' },
          'Dymorphism is not for you.',
        ),
      ),
      /* @__PURE__ */ jsx(
        'a',
        { className: 'list-group-item', href: '#', events: { click: female } },
        /* @__PURE__ */ jsx(
          'h4',
          { className: 'list-group-item-heading' },
          'Female',
      ...
      /* @__PURE__ */ jsx(
        'a',
        { className: 'list-group-item', href: '#', events: { click: herm } },
        /* @__PURE__ */ jsx(
          'h4',
          { className: 'list-group-item-heading' },
          'Hermaphrodite',
...
function PronounNode({ game: game2 }) {
  const pronounChoice = game2.pronoun.pipe(
    (0, import_rxjs3.map)((pronoun) =>
      !pronoun || pronoun === ''
        ? () =>
            /* @__PURE__ */ jsx(PronounChoice, { pronounVm: game2.pronounVm })
        : () =>
            /* @__PURE__ */ jsx(AfterPronoun, { pronounVm: game2.pronounVm }),
    ),
  )
  return /* @__PURE__ */ jsx(
    Fragment,
    ...
    /* @__PURE__ */ jsx(
      'h1',
      null,
      'Welcome to the Macro Transaction Force HQ!',
    ),
    /* @__PURE__ */ jsx(
      'p',
      null,
      'The building secretary robot eyeballs you just enough to feel like it knows everything about you, audibly sighs, and then presses an intercom button on its button-covered chest, not even bothering to try to catch your name.',
    ),
    /* @__PURE__ */ jsx(
      'p',
      null,
      '"Mr. Gravel?" the robot mechanically chirps to itself. You cannot hear the reply, only the robot continuing to itself, "You had an interview scheduled this space afternoon?" The robot nods in frustration, presumably while Mr. Gravel on the other end of the intercom remembers his agenda for the day. "Well, ',
      /* @__PURE__ */ jsx('em', null, 'she'),
      `'s here\u2026" The tone of the robot's pronoun choice sounds rather condescending for a machine.`,
    ),
    /* @__PURE__ */ jsx('div', {
      childrenBind: pronounChoice,
...
function PronounChoice({ pronounVm }, { bindImmediateEffect, events }) {
  ...
  return /* @__PURE__ */ jsx(
    ...
    /* @__PURE__ */ jsx(
      'a',
      { className: 'list-group-item', href: '#', events: { click: she } },
      /* @__PURE__ */ jsx(
        'h4',
        { className: 'list-group-item-heading' },
        '"She" is fine',
    ...
    /* @__PURE__ */ jsx(
      'a',
      { className: 'list-group-item', href: '#', events: { click: he } },
      /* @__PURE__ */ jsx(
        'h4',
        { className: 'list-group-item-heading' },
        '"HE"',
    ...
    /* @__PURE__ */ jsx(
      'a',
      { className: 'list-group-item', href: '#', events: { click: they } },
      /* @__PURE__ */ jsx(
        'h4',
        { className: 'list-group-item-heading' },
        `"I'm sorry, but it is 'they'\u2026"`,
      ),
      /* @__PURE__ */ jsx(
        'p',
        { className: 'list-group-item-text' },
        'This robot is truly mistaken.',
      ),
    ),
    /* @__PURE__ */ jsx(
      'div',
      ...
      /* @__PURE__ */ jsx(
        'p',
        { className: 'list-group-item-text' },
        /* @__PURE__ */ jsx('em', null, 'Module not found.'),
      ),
    ),
  )
}
function RobotResponseToShe() {
  return /* @__PURE__ */ jsx(
    'p',
    null,
    "You don't bother to correct the robot's pronoun usage, but you do give some wicked side-eye for its choice of tone.",
  )
}
...
function RobotResponseToThey() {
  return /* @__PURE__ */ jsx(
    'p',
    null,
    `"I'm sorry, but it is 'they'\u2026" you politely try to correct the robot. The robot glares at you and snarks back to the intercom, "They`,
    ' ',
    /* @__PURE__ */ jsx('em', null, 'is'),
    ' here\u2026".',
  )
}
function AfterPronoun({ pronounVm }, { bindImmediateEffect, events }) {
  ...
  return /* @__PURE__ */ jsx(
    Fragment,
    null,
    /* @__PURE__ */ jsx('hr', null),
    /* @__PURE__ */ jsx('div', {
      childrenBind: robotResponse,
      childrenBindMode: 'replace',
    }),
    /* @__PURE__ */ jsx(
      'p',
    ...
    /* @__PURE__ */ jsx(
      ...
      /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsx(
          'p',
          { className: 'list-group-item-text' },
          "In addition to the robot's rudeness, you finally notice the robot wears the insignia of the Devices of Devastation, a galactic gang of murderous robots you've sworn to destroy on sight.",
        ),
      ),
      /* @__PURE__ */ jsx(
        'a',
        { className: 'list-group-item', href: '#', events: { click: next } },
        /* @__PURE__ */ jsx(
          'h4',
          { className: 'list-group-item-heading' },
          'Wait Patiently',
...
function WeaponNode({ game: game2 }, { bindEffect, events }) {
  const { playerNameChanged } = events
  const { weaponVm } = game2
  const weaponChoice = game2.weapon.pipe(
    (0, import_rxjs4.map)((weapon) =>
      !weapon || weapon === ''
        ? () => /* @__PURE__ */ jsx(WeaponChoice, { weaponVm })
        : () => /* @__PURE__ */ jsx(AfterWeapon, { weaponVm }),
    ),
  )
  const afterExciting = weaponVm.exciting.pipe(
    (0, import_rxjs4.map)((exciting) =>
      exciting ? () => /* @__PURE__ */ jsx(AfterExciting, { weaponVm }) : Empty,
    ),
  )
  ...
  return /* @__PURE__ */ jsx(
    Fragment,
    null,
    /* @__PURE__ */ jsx('h1', null, "Mr. Gravel's Office"),
    /* @__PURE__ */ jsx(
      'p',
      null,
      '"Ah, ',
      /* @__PURE__ */ jsx('span', { bind: { innerText: game2.honorific } }),
      ' ',
      /* @__PURE__ */ jsx('input', {
        title: 'Player Name',
        type: 'text',
        bind: { defaultValue: game2.playerName },
        events: { change: playerNameChanged },
      }),
      ', I see you have brought your\u2026"',
    ),
    /* @__PURE__ */ jsx('div', {
      childrenBind: weaponChoice,
      childrenBindMode: 'replace',
    }),
    /* @__PURE__ */ jsx('div', {
      childrenBind: afterExciting,
      childrenBindMode: 'replace',
    }),
  )
}
function WeaponChoice({ weaponVm }, { bindImmediateEffect, events }) {
  ...
  return /* @__PURE__ */ jsx(
    Fragment,
    null,
    /* @__PURE__ */ jsx('h2', null, 'Choose Your Weapon'),
    /* @__PURE__ */ jsx(
      'div',
      { className: 'list-group' },
      /* @__PURE__ */ jsx(
        'a',
        { className: 'list-group-item', href: '#', events: { click: winks } },
        /* @__PURE__ */ jsx(
          'h4',
          { className: 'list-group-item-heading' },
          'Arsenal of Sly Winks',
        ),
        /* @__PURE__ */ jsx(
          'p',
          { className: 'list-group-item-text' },
      ...
      /* @__PURE__ */ jsx(
        'a',
        { className: 'list-group-item', href: '#', events: { click: clothes } },
        /* @__PURE__ */ jsx(
          'h4',
          { className: 'list-group-item-heading' },
          'Foppish Clothes',
      ...
      /* @__PURE__ */ jsx(
        'a',
        { className: 'list-group-item', href: '#', events: { click: swagger } },
        /* @__PURE__ */ jsx(
          'h4',
          { className: 'list-group-item-heading' },
      ...
      /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsx(
          ...
          /* @__PURE__ */ jsx(
            ...
            null,
            'Coming soon in our ',
            /* @__PURE__ */ jsx('strong', null, 'Ninja Pack'),
            ' DLC.',
          ),
        ),
      ),
...
function AfterWeapon({ weaponVm }) {
  const excitingChoice = weaponVm.exciting.pipe(
    (0, import_rxjs4.map)((exciting) =>
      !exciting
        ? () => /* @__PURE__ */ jsx(ExcitingChoice, { weaponVm })
        : Empty,
    ),
  )
  return /* @__PURE__ */ jsx(
    ...
    /* @__PURE__ */ jsx(
      ...
      null,
      '"\u2026',
      /* @__PURE__ */ jsx('span', { bind: { innerText: weaponVm.weapon } }),
      '. Excellent. That should come in handy later during our 8 hour testing phase of the interview."',
    ),
    /* @__PURE__ */ jsx('div', {
      childrenBind: excitingChoice,
      childrenBindMode: 'replace',
    }),
  )
}
    ...
    /* @__PURE__ */ jsx(
      ...
      /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsx(
          'p',
          { className: 'list-group-item-text' },
          "Why can't there be a reasonable work-life balance? Passion is no substitute for having a full life with friends outside work, maybe a family, and even some personal time.",
        ),
      ),
    ),
  )
...
// src/nodes/boss.tsx
function BossNode({ game: game2 }) {
  const bossVm = new BossVm()
  const teaChoice = bossVm.tea.pipe(
    (0, import_rxjs5.map)((tea) =>
      !tea
        ? () => /* @__PURE__ */ jsx(TeaChoice, { bossVm })
        : () => /* @__PURE__ */ jsx(AfterTea, { game: game2 }),
    ),
  )
  return /* @__PURE__ */ jsx(
    Fragment,
    null,
    /* @__PURE__ */ jsx('h1', null, 'Boss Stage!'),
    /* @__PURE__ */ jsx(
      'p',
      null,
      `Just as you utter the words, "I'm full of passion," the entire space station begins to shudder and shake. Very quickly a large laser beam blasts through station walls incinerating Mr. Gravel where he sat at his desk. Your emergency space suit activates just in time as the oxygen levels start to fall in the station.`,
    ),
    /* @__PURE__ */ jsx(
      'p',
      null,
      'Through the hole in the hull of the station a giant cyborg in top to bottom unrevealing power armor flies in, sealing the hole with a flick of the wrist while passing. You quickly recognize the emblem as the symbol for',
      /* @__PURE__ */ jsx('em', null, 'The Elucidator'),
      ". She is one of the most rogue of the Macro Transaction Force's rogue's gallery.",
    ),
    /* @__PURE__ */ jsx(
      'p',
      null,
      "You can feel The Elucidator's scanning beam examing you, and you prepare your ",
      /* @__PURE__ */ jsx('span', { bind: { innerText: game2.weapon } }),
      ' for a possible fight.',
    ),
    /* @__PURE__ */ jsx('div', {
      childrenBind: teaChoice,
      childrenBindMode: 'replace',
    }),
  )
}
  ...
  return /* @__PURE__ */ jsx(
    ...
    /* @__PURE__ */ jsx(
      ...
      /* @__PURE__ */ jsx(
        'p',
        { className: 'list-group-item-text' },
        'This would clearly be an amazing boss battle full of trying to find a weak point, exploiting said weak point, and then repeating those steps at least two more times.',
      ),
    ),
    /* @__PURE__ */ jsx(
      'a',
      { className: 'list-group-item', href: '#', events: { click: nextTea } },
      /* @__PURE__ */ jsx(
        'h4',
        { className: 'list-group-item-heading' },
        'Invite to Tea',
      ...
      /* @__PURE__ */ jsx(
        'p',
        { className: 'list-group-item-text' },
        "It may not be your office, but there's no reason to be uncivil even to an uninvited guest.",
      ),
    ),
  )
}
...
function ChefTea() {
  return /* @__PURE__ */ jsx(
    Fragment,
    null,
    'You manage to collect a couple biscotti from an emergency chef pouch and even work a small number of spaceberries into an impromptu spaceberry jam.',
  )
}
function AfterTea({ game: game2 }) {
  const chefTea = game2.className.pipe(
    (0, import_rxjs5.map)((className) =>
      className === 'Chef' ? ChefTea : Empty2,
    ),
  )
  const rechargeDate = 23 * 60 * 6e4
  const recharge = (0, import_rxjs5.interval)(
    1e3,
    /* ms */
  ).pipe(
    (0, import_rxjs5.map)((count) =>
      Math.max(
    ...
    (0, import_rxjs5.map)((time) =>
      new Date(time).toLocaleTimeString(void 0, {
        hour12: false,
        timeZone: 'UTC',
      }),
    ),
    (0, import_rxjs5.map)((formatted) => `AP ${formatted}`),
  )
  return /* @__PURE__ */ jsx(
    Fragment,
    null,
    ...
    /* @__PURE__ */ jsx(
      ...
      ' ',
      /* @__PURE__ */ jsx('span', { bind: { innerText: game2.race } }),
      ", which you never would have guessed. She nods patiently and sits down in Mr. Gravel's slightly scorched chair. Presumably she was unworried about the bits and pieces of Mr. Gravel between her power armor and the chair.",
    ),
    /* @__PURE__ */ jsx(
      'p',
      null,
      ...
      ' ',
      /* @__PURE__ */ jsx('span', {
        childrenBind: chefTea,
        childrenBindMode: 'replace',
      }),
      ` The Elucidator smiles a broad smile, "Here to try to fill one of the Macro Transaction Force's diversity quotas?"`,
    ),
    /* @__PURE__ */ jsx(
      'p',
      null,
      'Although unhappy with how blunt she was, you could only admit that she might have a point, "Seemed that way."',
    ),
    /* @__PURE__ */ jsx(
      'p',
      null,
      '"Getting the full spiel? Passion to save the galaxy from itself? Long hours, terrible pay, no free time?" She sips, a sly smile on her lips.',
    ),
    /* @__PURE__ */ jsx(
      'p',
      null,
      'You shrug, "We were working towards that. What is it to you?"',
    ),
    /* @__PURE__ */ jsx(
      'p',
      null,
      '"What has Macro Transaction Force done for ',
      /* @__PURE__ */ jsx('i', null, 'us'),
      ' lately?"',
    ),
    /* @__PURE__ */ jsx(
      'div',
      ...
      /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsx(
          'p',
          { className: 'list-group-item-text' },
          'Macro Transaction Force is the best and I will start by destroying one of its nemeses right here!',
        ),
      ),
      /* @__PURE__ */ jsx(
        'div',
        ...
        /* @__PURE__ */ jsx(
          ...
          /* @__PURE__ */ jsx(
            ...
            /* @__PURE__ */ jsx('span', { className: 'fa fa-clock-o' }),
            ' ',
            /* @__PURE__ */ jsx('span', { bind: { innerText: recharge } }),
          ),
        ),
        /* @__PURE__ */ jsx(
          'p',
      ...
      /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsx(
          'p',
          { className: 'list-group-item-text' },
          'Maybe The Elucidator is right and it is the Macro Transaction Force that should be taken down a peg! ',
          /* @__PURE__ */ jsx('em', null, 'Buy our Season Pass Today'),
          ' ',
          'and Get the ',
          /* @__PURE__ */ jsx(
            'strong',
            null,
            'Sidekick to The Elucidator Pack',
          ),
      ...
      /* @__PURE__ */ jsx(
        ...
        /* @__PURE__ */ jsx('h3', null, 'Coming Soon'),
        /* @__PURE__ */ jsx(
          'p',
          null,
          'Spam your friends, acquaintances, and significant frenemies on social networks to acquire more action points!',
        ),
      ),
    ),
  )
...
// src/nodes/index.tsx
var NodeComponents = {
  boss: (game2) => () => /* @__PURE__ */ jsx(BossNode, { game: game2 }),
  class: (game2) => () => /* @__PURE__ */ jsx(ClassNode, { game: game2 }),
  gender: (game2) => () => /* @__PURE__ */ jsx(GenderNode, { game: game2 }),
  pronoun: (game2) => () => /* @__PURE__ */ jsx(PronounNode, { game: game2 }),
  race: (game2) => () => /* @__PURE__ */ jsx(RaceNode, { game: game2 }),
  weapon: (game2) => () => /* @__PURE__ */ jsx(WeaponNode, { game: game2 }),
}
...
var GameVm = class {
  ...
  constructor() {
    ...
    this.#nodeComponent = this.node.pipe(
      ...
      (0, import_rxjs6.shareReplay)(1),
    )
    this.#honorific = this.pronoun.pipe(
      (0, import_rxjs6.map)((pronoun) => (pronoun === 'she' ? 'Ms.' : 'Mr.')),
    )
  }
  restart() {
    this.#setNode('race')
...
function GetStarted() {
  return /* @__PURE__ */ jsx(
    'p',
    null,
    'Please select a character race to get started.',
  )
}
function CharacterType({ game: game2 }) {
  return /* @__PURE__ */ jsx(
    'p',
    null,
    'You are ',
    /* @__PURE__ */ jsx('span', { bind: { innerText: game2.a } }),
    ' ',
    /* @__PURE__ */ jsx('span', { bind: { innerText: game2.gender } }),
    ' ',
    /* @__PURE__ */ jsx('span', { bind: { innerText: game2.race } }),
    ' ',
    /* @__PURE__ */ jsx('span', { bind: { innerText: game2.className } }),
    '.',
  )
}
function Empty3() {
...
function Weapon({ game: game2 }) {
  return /* @__PURE__ */ jsx(
    'p',
    null,
    'You are wielding your ',
    /* @__PURE__ */ jsx('span', { bind: { innerText: game2.weapon } }),
    '.',
  )
}
function GamePage(_props, { bindEffect, events }) {
  const game2 = new GameVm()
  const nodeComponent = game2.nodeComponent.pipe(
    (0, import_rxjs7.map)((nodeComponent2) => nodeComponent2 ?? NodeNotFound),
    (0, import_operators.tag)('game-node-component'),
  )
  const characterType = game2.race.pipe(
    (0, import_rxjs7.map)((race2) =>
      !race2 || race2 === ''
        ? GetStarted
        : () => /* @__PURE__ */ jsx(CharacterType, { game: game2 }),
    ),
  )
  const ap = game2.ap.pipe((0, import_rxjs7.map)((ap2) => ap2.toLocaleString()))
  const weapon = game2.weapon.pipe(
    (0, import_rxjs7.map)((weapon2) =>
      !weapon2 || weapon2 === ''
        ? Empty3
        : () => /* @__PURE__ */ jsx(Weapon, { game: game2 }),
    ),
  )
  ...
  return /* @__PURE__ */ jsx(
    ...
    /* @__PURE__ */ jsx(
      'div',
      { className: 'col-md-2' },
      /* @__PURE__ */ jsx('h3', { bind: { innerText: game2.playerName } }),
      /* @__PURE__ */ jsx('div', {
        childrenBind: characterType,
        childrenBindMode: 'replace',
      }),
      /* @__PURE__ */ jsx('h3', null, 'Assets'),
      /* @__PURE__ */ jsx(
        'p',
        null,
        'You currently have',
      ...
      /* @__PURE__ */ jsx('h3', null, 'Game Options'),
      /* @__PURE__ */ jsx(
        'button',
        {
          type: 'button',
...
var Router = class {
  ...
  constructor() {
    const hash = (0, import_rxjs8.concat)(
      (0, import_rxjs8.of)(location.hash),
      (0, import_rxjs8.fromEvent)(window, 'hashchange').pipe(
        (0, import_rxjs8.map)(() => location.hash),
      ),
    )
    this.#page = hash.pipe(
      (0, import_rxjs8.map)((hash2) => Routes[hash2] ?? 'home'),
      (0, import_rxjs8.shareReplay)(1),
    )
    this.#component = this.page.pipe(
      (0, import_rxjs8.map)((pageName) => PageComponents[pageName]),
    )
  }
}
...
function Main() {
  ...
  const pageComponent = router2.component.pipe(
    (0, import_rxjs9.map)((component) => component ?? PageNotFound),
  )
  return /* @__PURE__ */ jsx(
    Fragment,
    null,
    /* @__PURE__ */ jsx(NavBar, { router: router2 }),
    /* @__PURE__ */ jsx('div', {
      id: 'page',
      className: 'container',
    ...
    /* @__PURE__ */ jsx(
      ...
      /* @__PURE__ */ jsx(
        'small',
        null,
        'Copyright \xA9 2014 Max Battcher. Some rights reserved.',
      ),
    ),
  )
}
...
var { document } = window2
var container = document.querySelector('#container')
globalThis.location = window2.location
globalThis.window = window2
var mainStamp = buildStamp(Main(), document)
container.append(mainStamp.content)
var pageNotFoundStamp = buildStamp(PageNotFound(), document)
pageNotFoundStamp.id = 'page-not-found'
container.append(pageNotFoundStamp)
var router = new Router()
var navBarStamp = buildStamp(NavBar({ router }), document)
navBarStamp.id = 'navbar'
container.append(navBarStamp)
var homeStamp = buildStamp(HomePage(), document)
homeStamp.id = 'home-page'
container.append(homeStamp)
var aboutStamp = buildStamp(AboutPage(), document)
aboutStamp.id = 'about-page'
container.append(aboutStamp)
var { context: gameContext } = makeTestComponentContext({
  restart: makeTestEvent(import_rxjs10.NEVER),
})
var gameStamp = buildStamp(GamePage({}, gameContext), document)
gameStamp.id = 'game-page'
container.append(gameStamp)
var nodeNotFoundStamp = buildStamp(NodeNotFound(), document)
nodeNotFoundStamp.id = 'node-not-found'
container.append(nodeNotFoundStamp)
var getStartedStamp = buildStamp(GetStarted(), document)
getStartedStamp.id = 'get-started'
container.append(getStartedStamp)
var game = new GameVm()
var characterTypeStamp = buildStamp(CharacterType({ game }), document)
characterTypeStamp.id = 'character-type'
container.append(characterTypeStamp)
var emptyStamp = buildStamp(Empty3(), document)
emptyStamp.id = 'empty'
container.append(emptyStamp)
var weaponStamp = buildStamp(Weapon({ game }), document)
weaponStamp.id = 'weapon'
container.append(weaponStamp)
var { context: raceContext } = makeTestComponentContext({
  darkstar: makeTestEvent(import_rxjs10.NEVER),
  rabbit: makeTestEvent(import_rxjs10.NEVER),
  seductrix: makeTestEvent(import_rxjs10.NEVER),
})
var raceStamp = buildStamp(RaceNode({ game }, raceContext), document)
raceStamp.id = 'race'
